    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">View DSyirkah Aktif Emas</h4>
            </div>
        </div>
    </div>
    <!-- end page title --> 
        ...
        <div class="col-12">
            <div class="card">
                <div class="modal-header" style="background-color: goldenrod">
                    <h4 class="title" style="color: rgb(255, 255, 255);" id="data-pengajuan-emas">View DSyirkah Aktif Emas</h4>
                </div>
                <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="font-14">: {{$pengajuan->perpanjangan_emas->get(0)->tgl_akad_baru}} </p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="font-14">:
                            {{$pengajuan->perpanjangan_emas()->orderBy("jatuh_tempo_akan_datang","asc")->where('status','Approved')->first()->jatuh_tempo_akan_datang}}
                        </p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-6">
                        <p class="font-14">:
                            {{$pengajuan->perpanjangan_emas()->orderBy("jatuh_tempo_akan_datang","asc")->where('status','Approved')->first()->nisbah}}
                        </p>
                    </div>
                </div>
                <div class="row">
...
<script>
    function printData() {
        var divContents = document.getElementById("emas_aktif_print").innerHTML;
