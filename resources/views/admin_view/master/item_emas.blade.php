                    ...
                    <div class="col-xxl-7 col-lg-5">
                        <div class="card">
                            ...
                            <div class="modal-header" style="background-color: #afb4be">
                                <div style="color: rgb(255, 255, 255);"><h4 id="modalHeading">Tambah Emas</h4></div>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                            </div>
                            <div class="card-body p-4">
                                <form id="ItemEmasForm" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="mb-3 text-center" >
                                        <button class="btn btn-primary" style="display: none" id="editBtn" type="submit"> Update </button>
                                    </div>
    ...
    $(function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'gramasi', name: 'gramasi', orderSequence:['asc']},
        ...
        $.get("item_emas" +'/' + id_emas +'/edit', function (data) {
            $(`#jenis_emas option`).removeAttr('selected');
            $(`#statusAdd option`).removeAttr('selected');
            ...
            $(`#jenis_emas option[value="${data.jenis}"]`).attr('selected','true');
            $('#gramasi').val(data.gramasi);
            $(`#statusAdd option[value=${data.status}]`).attr('selected','true');
            $('body').on('click','.btn-close', function(){
                ...
                $('#modal-tambah-namaemas').modal('show');
                $('#nama_emas').val('');
                // $(`#jenis_emas option[value="${data.jenis}"]`).removeAttr('selected');
                // $(`#statusAdd option[value=${data.status}]`).removeAttr('selected');
                $('#gramasi').val('');
            })
        })
        });
