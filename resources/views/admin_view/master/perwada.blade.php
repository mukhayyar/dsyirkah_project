...
<!-- Start Content-->
                                                ...
                                                <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="javascript:void(0);" class="action-icon" data-bs-toggle="modal" data-bs-target="#modal-edit-perwada"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>2</td>
                                        ...
                                        <div class="col-xxl-7 col-lg-5">
                                            <div class="card">
                                                ...
                                                <div class="modal-header" style="background-color: #afb4be">
                                                    <div style="color: rgb(255, 255, 255);"><h4>Tambah Perwada</h4></div>
                    ...
                    <div class="modal fade" id="modal-edit-perwada" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg loading authentication-bg">
                            <div class="modal-content bg-transparent">
                            <div class="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5">
                                <div class="container">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body p-4">
                                                    <form action="#">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="fullname" class="form-label">Kode</label>
                                                            <input class="form-control" type="text" placeholder="000" id="fullname" readonly="">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="fullname" class="form-label">Nama Perwada</label>
                                                            <input class="form-control" type="text" id="fullname" placeholder="KP Pusat" readonly="">
                                                        </div>
