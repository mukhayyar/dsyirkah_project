                            ...
                            <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view-nonaktif-rupiah.html" class="action-icon"> <i class="mdi mdi-card-search-outline"></i></a>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body p-4">
                                                        <form action="#">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="fullname" class="form-label">Upload Bukti Transfer</label>
